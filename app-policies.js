  ...
  function sPartnerPrivacyKo() {
    return '' +
      ...
      '<ul class="pol-list">' +
        ...
        '<li><strong>모집 게시글 연락 수단:</strong> 인앱 채팅을 회원 간 기본 연락 수단으로 제공합니다. 현재 버전에서는 모집 게시글에서 카카오 오픈채팅·텔레그램 등 외부 연락 링크를 더 이상 입력받지 않으며, 인앱 채팅으로 대체되었습니다. 다만 과거 버전에서 등록된 일부 게시글에는 기존에 입력된 외부 링크가 남아 있을 수 있습니다.</li>' +
