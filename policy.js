  ...
  window.AF.register({
    ...
    ko: {
      legal: {
        ...
        appPointerH: '앱별 정책',
        appPointerB: 'AppFactory가 운영하는 각 앱(S Partner, MBTI Swipe, Pickleball Partner Match)의 상세 정책은 앱별 정책 페이지에서 확인할 수 있습니다.',
      ...
      deletePage: {
        ...
        emailSubject: '제목 예시: “Account Deletion Request - S Partner / MBTI Swipe / Pickleball Partner Match”',
        s2h: '삭제되는 데이터',
    ...
    en: {
      legal: {
        ...
        appPointerB: 'Detailed policies for each app operated by AppFactory (S Partner, MBTI Swipe, Pickleball Partner Match) are available on the App Policies pages.',
      ...
      deletePage: {
        ...
        emailSubject: 'Example subject: “Account Deletion Request - S Partner / MBTI Swipe / Pickleball Partner Match”',
    ...
    ja: {
      legal: {
        ...
        appPointerB: 'AppFactoryが運営する各アプリ（S Partner、MBTI Swipe、Pickleball Partner Match）の詳細ポリシーは、アプリ別ポリシーのページでご確認いただけます。',
      ...
      deletePage: {
        ...
        emailSubject: '件名の例: 「Account Deletion Request - S Partner / MBTI Swipe / Pickleball Partner Match」',
        s2h: '削除されるデータ',
    ...
    vi: {
      legal: {
        ...
        appPointerB: 'Chính sách chi tiết của từng ứng dụng do AppFactory vận hành (S Partner, MBTI Swipe, Pickleball Partner Match) có trên các trang Chính sách theo ứng dụng.',
      ...
      deletePage: {
        ...
        emailSubject: 'Ví dụ tiêu đề: “Account Deletion Request - S Partner / MBTI Swipe / Pickleball Partner Match”',
